...
export function frontDoorPassword(word) {
  ...
  let capitalLetter = password.charAt(0).toUpperCase();
  let remainingLetters = password.slice(1);
...
export function backDoorPassword(word) {
  ...
  return `${capitalLetter}${remainingLetters}, please`;
}
